...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
        <h1 class="text-primary fw-bold mb-0">🎓 Teacher Update Details</h1>
    </div>

    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('student-profiles.index') }}">All Teacher</a></li>
        <li class="breadcrumb-item active">Update Teacher Data</li>
    </ol>
            ...
            <form action="{{route('teachers.update',$teachers->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="name" value="{{old('name',$teachers->user->name)}}" class="form-control"
                            required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Teacher Email</label>
                        <input type="email" name="email" value="{{old('email',$teachers->user->email)}}" class="form-control"
                            required>
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="aadhaar_no" value="{{old('aadhaar_no',$teachers->aadhaar_no)}}" class="form-control">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Education</label>
                        <input type="text" name="education" value="{{old('education',$teachers->education)}}" class="form-control">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Subject</label>
                        <input type="text" name="subject" value="{{old('subject',$teachers->subject)}}" class="form-control">
                    </div>
                   
                    <div class="col-md-12 mb-3">
                        <label class="form-label">Address</label>
                        <textarea name="address" class="form-control" rows="2">{{old('address',$teachers->address)}}</textarea>
                    </div>
                    <div class="col-md-12 mb-3">
